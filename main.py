...
#     return 0
# #
# models_info = [#{'title': 'bumbling-sweep-3', 'wandb_rep': 'model-bumbling-sweep-3', 'version': 'v19', 'pred_type': 'Distance'},
#                #{'title': 'solar-sweep-11', 'wandb_rep': 'model-solar-sweep-11', 'version': 'v46', 'pred_type': 'Angle'},
#                {'title': 'bumbling-sweep-3', 'wandb_rep': 'Proto_distance_trained_models', 'version': 'v2', 'pred_type': 'Distance'},
#                {'title': 'solar-sweep-11', 'wandb_rep': 'Proto_angle_trained_models', 'version': 'v1', 'pred_type': 'Angle'},
